...
class TestBinarySearchTree(unittest.TestCase):
    ...
    def test_insert(self):
        ...
        self.tree = BinarySearchTree()
        self.set_tree()
        self.assertEqual(str(self.tree), "(2)[(1)[X][X]][(5)[(3)[X][(4)[X][X]]][X]]")
    ...
    def test_items(self):
        ...
        self.add_items(5)
        self.assertEqual(self.tree.items().get(0).get_element(), "value_1")
        self.assertEqual(self.tree.items().get(1).get_element(), "value_2")
        self.assertEqual(self.tree.items().get(2).get_element(), "value_3")
        self.assertEqual(self.tree.items().get(3).get_element(), "value_4")
        self.assertEqual(self.tree.items().get(4).get_element(), "value_5")
        self.assertEqual(self.tree.items().get(0).get_key(), 1)
        self.assertEqual(self.tree.items().get(1).get_key(), 2)
        self.assertEqual(self.tree.items().get(2).get_key(), 3)
        self.assertEqual(self.tree.items().get(3).get_key(), 4)
        self.assertEqual(self.tree.items().get(4).get_key(), 5)
    ...
    def test_remove_min_right_node(self):
        self.tree.insert(3, "value_3")
        self.tree.insert(5, "value_5")
        self.tree.insert(2, "value_2")
        self.tree.insert(4, "value_4")
        self.tree.insert(1, "value_1")
        self.assertEqual(self.tree.remove_min_right_node(self.tree.root).get_key(), 4)
        self.tree = BinarySearchTree()
        self.tree.insert(2, "value_2")
        self.tree.insert(5, "value_5")
        self.tree.insert(1, "value_1")
        ...
        self.tree.insert(4, "value_4")
        self.assertEqual(str(self.tree), "(2)[(1)[X][X]][(5)[(3)[X][(4)[X][X]]][X]]")
        self.assertEqual(self.tree.remove_min_right_node(self.tree.root).get_key(), 3)
        self.assertEqual(str(self.tree), "(2)[(1)[X][X]][(5)[(4)[X][X]][X]]")
